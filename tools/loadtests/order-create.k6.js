...
const payloadPath = __ENV.PAYLOAD_PATH || './order-request.json';
...
const startRps = Number(__ENV.START_RPS || 10);
const midRps = Number(__ENV.MID_RPS || 50);
const maxRps = Number(__ENV.MAX_RPS || 200);
...
const maxVUsRps = Number(__ENV.MAX_VUS || 1000);
